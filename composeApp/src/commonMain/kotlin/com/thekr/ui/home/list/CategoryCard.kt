...
import com.thekr.ui.theme.ImageResourceHelper.getResourceIdFromFileName
 ...
 * @param onClick Callback function to be invoked when a category is clicked.
 */
@Composable
fun CategoryList(
...
/**
 * Represents a single item in the category list.
 * Displays a CategoryCard and a divider.
 *
 * @param item The category details for the list item.
 * @param settingsDetails The settings detail for theming and customization.
 * @param onClick Callback function to be invoked when the category card is clicked.
 */
@Composable
...
/**
 * Displays a category card with an optional icon, title, and navigation arrow.
 *
 * @param settingsDetails The settings detail for theming and customization.
...
fun CategoryCard(
    ...
    Row(
        ...
        if (iconFileName != null) {
            val iconResId = getResourceIdFromFileName(fileName = iconFileName)
            if (iconResId != null) {
                Image(
